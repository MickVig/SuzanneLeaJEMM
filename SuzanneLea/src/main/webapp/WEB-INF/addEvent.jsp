		...
		<section>
			...
			<div class="w3-container">
				<form id="addEven" method="post" action="">
					...
					<br> 
					<label for="datepicker" class="w3-text-teal">Date</label>
					<input class="w3-input w3-border" id="datepicker" name="datepicker" type="text"> <br>
					
					<div class="w3-row">
						<label for="heure" class="w3-text-teal">Heure</label>
						<br>
						<input class="w3-input w3-border w3-quarter" id="heure" name="heure" type="text" placeholder="heure"> 
						<div class="s2p"><p>&nbsp;:&nbsp;</p></div>
						<input class="w3-input w3-border w3-quarter" id="minute" name="minute" type="text" placeholder="minute">
					</div>
					<br> 
					<label for="contenu" class="w3-text-teal">Evènement</label>
					<textarea id="contenu" name="contenu" class="w3-input w3-border" placeholder="Description de l'évènement"></textarea>
					<br> 
